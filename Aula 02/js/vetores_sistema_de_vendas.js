...
// após o cadastro exibir o nome e o valor do primeiro veiculo e do ultimo 
...
alert("O primeiro veículo foi "+nomes[nomes.length-1] +" custando R$ "+valores[valores.length-1])